...
## پرامپت ۳۷
در نوار ابزار یک گرینه برای رنگ‌آمیزی ایجاد کن، با زدن این دکمه زیر اون سه گزینه باز بشه تا کاربر انتخاب کن چه بخشی از نقشه‌ذهنی را می‌خواد تغییر رنگ بده. 
1. حاشیه گره
2. پس‌زمینه گره
3. خط اتصال گره‌ها

## پرامپت ۳۸
استایل دکمه‌های رنگ‌بندی به صورت افقی در کنار هم قرار نگرفتن. حالت فعلی حفظ بشه، فقط و فقط چینش دکمه‌ها رو درست کن.

## پرامپت ۳۹
تغییرات زیر را انجام بده:
1. در زمان ویرایش یک گره اندازه آن بزرگ می‌شود در حالیکه باید اندازه اون با توجه به متن باشه.
2. با زدن دکمه‌ها shift+enter خط جدید در گره ایجاد بشه.
3. در زمان ویرایش گره برای ثبت متن باید حتما enter زد، اگر کاربر خارج از گره کلیک کرد اطلاعات گره ثبت بشن.

## پرامپت ۴۰
عرض گره جدید زیاد است، عرض آن به اندازه متن «گره جدید» باشه.